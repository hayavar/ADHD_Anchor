...
Anchor should follow a minimal-data approach.

The current prototype is designed to collect:

- Declared task
- Terminal activity
- Active Safari tab title
...
- Page contents
- Browser history
- Keystroke analytics outside the watched terminal
- Passwords

Before using Anchor with sensitive data or deploying it beyond a personal prototype, review the data flow, permissions, logging behavior, and AI API usage carefully.
...
> **Don't force people to focus. Help them notice when they've drifted from what they said mattered.**

The long-term vision is an externalized focus layer that can understand intent, recognize meaningful work patterns, detect sustained drift, and provide a timely, respectful nudge—without taking control away from the user.

---

## 👥 Team

Built as a hackathon project by the Anchor team.
